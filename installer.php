...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220404_suiviapprenant_1d7fe265272197254753_20220404102025_archive.zip';
	const ARCHIVE_SIZE		 = '97853239';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '1d7fe26-04102025';
    const SECONDARY_PACKAGE_HASH = 'ed67859-04102025';
	const VERSION			 = '1.4.4';
